...
public class SomeRecords implements TaskType{
    ...
    public void run(LoadBalancerQueryOuterClass.query request, StreamObserver<LoadBalancerQueryOuterClass.result> responseObserver, int serverPort, String host) {
        ...
        DataServerQueryOuterClass.query query = DataServerQueryOuterClass.query.newBuilder().setStationId(request.getStationId()).build();
        ...
        asyncStub.getSomeRecords(query,serverResponseObserver);
        try {
